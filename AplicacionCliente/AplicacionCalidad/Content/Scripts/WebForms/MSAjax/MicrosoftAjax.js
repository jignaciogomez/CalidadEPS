...
Sys.Serialization.JavaScriptSerializer.deserialize = function(data, secure) {
    ...
    try {
        ...
        if (secure &&
            Sys.Serialization.JavaScriptSerializer._jsonRegEx.test(exp.replace(Sys.Serialization.JavaScriptSerializer
                ._jsonStringRegEx,
                ""))) throw null;
        return eval("(" + exp + ")")
    } catch (a) {
...
if (document.documentElement.getBoundingClientRect)
    Sys.UI.DomElement.getLocation = function(a) {
        if (a.self ||
            ...
            a.parentNode === a.ownerDocument.documentElement) return new Sys.UI.Point(0, 0);
...
Sys._ScriptLoaderTask._clearScript =
    function(a) { if (!Sys.Debug.isDebug && a.parentNode) a.parentNode.removeChild(a) };
Type.registerNamespace("Sys.Net");
