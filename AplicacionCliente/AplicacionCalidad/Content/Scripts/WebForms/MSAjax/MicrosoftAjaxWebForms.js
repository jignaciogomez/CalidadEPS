...
Type._registerScript("MicrosoftAjaxWebForms.js",
    [
        "MicrosoftAjaxCore.js", "MicrosoftAjaxSerialization.js", "MicrosoftAjaxNetwork.js",
...
Sys.WebForms.EndRequestEventArgs.prototype = {
    ...
    get_errorHandled: function() { return this._errorHandled },
    set_errorHandled: function(a) { this._errorHandled = a },
    get_response: function() { return this._response }
};
...
Sys.WebForms.PageLoadedEventArgs.prototype = {
    get_dataItems: function() { return this._dataItems },
    get_panelsCreated: function() { return this._panelsCreated },
    get_panelsUpdated: function() { return this._panelsUpdated }
};
...
Sys.WebForms.PageLoadingEventArgs.prototype = {
    get_dataItems: function() { return this._dataItems },
    get_panelsDeleting: function() { return this._panelsDeleting },
...
Sys._ScriptLoader.prototype = {
    ...
    _nextSession: function() {
        ...
        if (a.scriptTimeout > 0)
            this._timeoutCookie = window.setTimeout(Function.createDelegate(this, this._scriptLoadTimeoutHandler),
...
Sys.WebForms.PageRequestManager.prototype = {
    ...
    _onFormSubmit: function(i) {
        ...
        if (k) {
            d = new Sys.WebForms.BeginRequestEventArgs(c,
    ...
    _onFormSubmitCompleted: function(c) {
        ...
        if (!a) return;
        var b, e;
        if (a.asyncPostBackControlIDsNode &&
            ...
            for (b = 0, e = g.length; b < e; b += h ? 2 : 1) {
                ...
                if (!document.getElementById(j)) {
                    this._endPostBack(Error.invalidOperation(String.format(Sys.WebForms.Res.PRM_MissingPanel, j)),
                        c,
                        a);
                    return
                }
    ...
    _parseDelta: function(h) {
        ...
        for (var l = 0, G = k.length; l < G; l++) {
            ...
            case "pageRedirect":
                ...
                return null;
            case "error":
                this._endPostBack(this._createPageRequestManagerServerError(Number.parseInvariant(a.id), a.content),
                    h,
                    null);
                return null;
            case "pageTitle":
    ...
    _scriptIncludesLoadComplete: function(e, b) {
        ...
        for (a = 0, d = b.updatePanelNodes.length; a < d; a++) {
            ...
            if (!j) {
                this._endPostBack(Error.invalidOperation(String.format(Sys.WebForms.Res.PRM_MissingPanel, c.id)),
                    b.executor,
                    b);
                return
            }
        ...
        e.loadScripts(0,
            Function.createDelegate(this, Function.createCallback(this._scriptsLoadComplete, b)),
            null,
            null)
    },
